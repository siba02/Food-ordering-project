...
export default function RestaurantCard({ item }) {
  ...
  const handleDeleteRestaurant = () => {
    dispatch(deleteRestaurant({ restaurantId: item.id, jwt: localStorage.getItem("jwt") }));
  };
  ...
  return (
    <Card sx={{ maxWidth: 345, m: "1rem" }}>
      <CardHeader
        avatar={
          <Avatar sx={{ bgcolor: "#e91e63", color: "white" }} aria-label="recipe">
            Z
          </Avatar>
        }
        action={
      ...
      {/* <CardMedia
        ...
        alt="Paella dish"
      /> */}
      <img className="h-[17rem] w-full object-cover" src={item.images[0]} alt="" />
      <CardContent>
